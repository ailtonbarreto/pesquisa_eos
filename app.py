...
contagem_categorias = contagem_categorias.sort_values(contagem_categorias[1])
...
bar_char_gestor = px.bar(contagem_categorias, x=contagem_categorias.values, y=contagem_categorias.index,category_orders={'Categoria':categorias},
