...
bar_char_gestor = px.bar(contagem_categorias, x=contagem_categorias.values, y=contagem_categorias.index,category_orders={contagem_categorias.index:categorias},
